...
# Configure Application Gateway path-based routing for NBRLY tenant apps
# This script sets up URL path map routing:
# - /nbapp1 -> nbapp1 Container App
# - /nbapp2 -> nbapp2 Container App
# Usage: ./scripts/configure-routing-nbrly.sh
...
TENANT_NAME="nbrly"
TENANT_HOSTNAME="nbrly-dev.astrapia.io"
...
log_info "  /nbapp1/* -> NBRLY App1"
log_info "  /nbapp2/* -> NBRLY App2"
log_info ""
log_info "Access via: https://${TENANT_HOSTNAME}/nbapp1"
log_info "Access via: https://${TENANT_HOSTNAME}/nbapp2"
