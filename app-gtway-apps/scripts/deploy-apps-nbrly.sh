...
# Deploy NBRLY tenant apps to Container App Environment
# Usage: ./scripts/deploy-apps-nbrly.sh <environment> <image-tag>
...
log_info "========================================================"
log_info "Deploying NBRLY Tenant Apps"
log_info "========================================================"
...
# Deploy NBAPP1
log_info "Deploying NBAPP1..."
NBAPP1_NAME="${TENANT_NAME}-dev-eastus-nbapp1-ca"
...
log_success "NBAPP1 deployed: $NBAPP1_NAME"

# Deploy NBAPP2
log_info "Deploying NBAPP2..."
NBAPP2_NAME="${TENANT_NAME}-dev-eastus-nbapp2-ca"
...
log_success "NBAPP2 deployed: $NBAPP2_NAME"

log_info "========================================================"
log_info "NBRLY Tenant Apps Deployment Complete"
log_info "========================================================"
log_info "NBAPP1: $NBAPP1_NAME"
log_info "NBAPP2: $NBAPP2_NAME"
